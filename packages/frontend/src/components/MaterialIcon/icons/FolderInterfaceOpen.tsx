...
function FolderInterfaceOpenSvg(): React.ReactNode {
...
function FolderInterfaceOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderInterfaceOpenSvg} {...props} />
};
