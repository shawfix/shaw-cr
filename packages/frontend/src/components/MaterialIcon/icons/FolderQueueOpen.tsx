...
function FolderQueueOpenSvg(): React.ReactNode {
...
function FolderQueueOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderQueueOpenSvg} {...props} />
};
