...
function FolderTypescriptSvg(): React.ReactNode {
...
function FolderTypescriptIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderTypescriptSvg} {...props} />
};
