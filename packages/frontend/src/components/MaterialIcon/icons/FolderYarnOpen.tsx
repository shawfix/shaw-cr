...
function FolderYarnOpenSvg(): React.ReactNode {
...
function FolderYarnOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderYarnOpenSvg} {...props} />
};
