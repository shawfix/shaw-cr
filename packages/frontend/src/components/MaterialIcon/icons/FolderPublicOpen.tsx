...
function FolderPublicOpenSvg(): React.ReactNode {
...
function FolderPublicOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderPublicOpenSvg} {...props} />
};
