...
function FolderSvgOpenSvg(): React.ReactNode {
...
function FolderSvgOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderSvgOpenSvg} {...props} />
};
