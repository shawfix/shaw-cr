...
function FolderCypressOpenSvg(): React.ReactNode {
...
function FolderCypressOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderCypressOpenSvg} {...props} />
};
