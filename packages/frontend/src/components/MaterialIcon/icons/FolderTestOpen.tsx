...
function FolderTestOpenSvg(): React.ReactNode {
...
function FolderTestOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderTestOpenSvg} {...props} />
};
