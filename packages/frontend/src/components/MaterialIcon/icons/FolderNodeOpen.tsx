...
function FolderNodeOpenSvg(): React.ReactNode {
...
function FolderNodeOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderNodeOpenSvg} {...props} />
};
