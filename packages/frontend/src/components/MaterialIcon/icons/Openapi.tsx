...
function OpenapiSvg(): React.ReactNode {
  ...
  <path fill="var(--material-icon-color, #e0e0e0)" d="M19.53 2a2.46 2.46 0 0 0-1.74.72 2.47 2.47 0 0 0-.47 2.84l-5.37 5.37a2.47 2.47 0 1 0 1.12 1.12l5.37-5.37a2.47 2.47 0 0 0 2.84-3.96A2.46 2.46 0 0 0 19.53 2"></path>
</svg>
;
};

function OpenapiIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={OpenapiSvg} {...props} />
};
