...
function FolderEnvironmentOpenSvg(): React.ReactNode {
...
function FolderEnvironmentOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderEnvironmentOpenSvg} {...props} />
};
