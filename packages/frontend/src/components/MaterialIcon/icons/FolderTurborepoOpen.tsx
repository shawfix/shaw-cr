...
function FolderTurborepoOpenSvg(): React.ReactNode {
...
function FolderTurborepoOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderTurborepoOpenSvg} {...props} />
};
