...
function FolderQuasarOpenSvg(): React.ReactNode {
...
function FolderQuasarOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderQuasarOpenSvg} {...props} />
};
