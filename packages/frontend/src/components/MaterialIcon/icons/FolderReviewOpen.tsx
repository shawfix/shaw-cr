...
function FolderReviewOpenSvg(): React.ReactNode {
...
function FolderReviewOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderReviewOpenSvg} {...props} />
};
