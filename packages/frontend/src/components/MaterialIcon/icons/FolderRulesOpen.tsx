...
function FolderRulesOpenSvg(): React.ReactNode {
...
function FolderRulesOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderRulesOpenSvg} {...props} />
};
