...
function FolderRustSvg(): React.ReactNode {
...
function FolderRustIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderRustSvg} {...props} />
};
