...
function FolderMojoOpenSvg(): React.ReactNode {
...
function FolderMojoOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderMojoOpenSvg} {...props} />
};
