...
function FolderTemplateSvg(): React.ReactNode {
...
function FolderTemplateIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderTemplateSvg} {...props} />
};

export default FolderTemplateIcon;
