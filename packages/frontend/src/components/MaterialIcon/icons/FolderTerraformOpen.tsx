...
function FolderTerraformOpenSvg(): React.ReactNode {
...
function FolderTerraformOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderTerraformOpenSvg} {...props} />
};
