...
function FolderReactComponentsOpenSvg(): React.ReactNode {
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="1em" height="1em">
  <path fill="var(--material-icon-color, #00bcd4)" d="M14.484 6H4.72a1 1 0 0 0-.949.684L2 12V5h13a1 1 0 0 0-1-1H7.562a1 1 0 0 1-.64-.232l-.644-.536A1 1 0 0 0 5.638 3H2a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h11l2.403-5.606A1 1 0 0 0 14.483 6"></path>
  <g fill="#b2ebf2">
...
function FolderReactComponentsOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderReactComponentsOpenSvg} {...props} />
};
