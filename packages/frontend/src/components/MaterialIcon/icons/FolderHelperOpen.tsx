...
function FolderHelperOpenSvg(): React.ReactNode {
...
function FolderHelperOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderHelperOpenSvg} {...props} />
};
