...
function FolderBatchOpenSvg(): React.ReactNode {
...
function FolderBatchOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderBatchOpenSvg} {...props} />
};
