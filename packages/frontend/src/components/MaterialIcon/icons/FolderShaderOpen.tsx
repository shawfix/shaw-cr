...
function FolderShaderOpenSvg(): React.ReactNode {
...
function FolderShaderOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderShaderOpenSvg} {...props} />
};
