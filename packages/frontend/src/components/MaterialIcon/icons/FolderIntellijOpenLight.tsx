...
function FolderIntellijOpenLightSvg(): React.ReactNode {
  ...
  <defs data-mit-no-recolor>
    <linearGradient id="a" x1=".445" x2="104.977" y1="3611.926" y2="3548.833" gradientTransform="translate(18.126 -368.395)scale(.11021)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#fdd835"></stop>
      <stop offset="1" stop-color="#f57c00"></stop>
    </linearGradient>
    <linearGradient id="b" x1="22.55" x2="117.962" y1="3460.434" y2="3543.963" gradientTransform="translate(18.126 -368.395)scale(.11021)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#ef5350"></stop>
      <stop offset=".57" stop-color="#ff6e40"></stop>
      <stop offset="1" stop-color="#f57c00"></stop>
    </linearGradient>
    <linearGradient id="c" x1="28.608" x2="-27.937" y1="3536.154" y2="3500.841" gradientTransform="translate(18.126 -368.395)scale(.11021)" gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="d" x1="27.588" x2="-27.616" y1="3456.176" y2="3501.769" gradientTransform="translate(18.126 -368.395)scale(.11021)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#ef5350"></stop>
      <stop offset=".364" stop-color="#ec407a"></stop>
      <stop offset="1" stop-color="#ec407a"></stop>
    </linearGradient>
  </defs>
  <path fill="var(--material-icon-color, #b0bec5)" d="M28.967 12H9.442a2 2 0 0 0-1.898 1.368L4 24V10h24a2 2 0 0 0-2-2H15.124a2 2 0 0 1-1.28-.464l-1.288-1.072A2 2 0 0 0 11.276 6H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h22l4.805-11.212A2 2 0 0 0 28.967 12"></path>
...
function FolderIntellijOpenLightIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderIntellijOpenLightSvg} {...props} />
};

export default FolderIntellijOpenLightIcon;
