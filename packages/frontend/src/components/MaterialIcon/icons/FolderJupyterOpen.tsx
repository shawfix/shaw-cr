...
function FolderJupyterOpenSvg(): React.ReactNode {
...
function FolderJupyterOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderJupyterOpenSvg} {...props} />
};
