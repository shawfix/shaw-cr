...
function FolderNuxtSvg(): React.ReactNode {
...
function FolderNuxtIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderNuxtSvg} {...props} />
};
