...
function FolderLinkSvg(): React.ReactNode {
...
function FolderLinkIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderLinkSvg} {...props} />
};
