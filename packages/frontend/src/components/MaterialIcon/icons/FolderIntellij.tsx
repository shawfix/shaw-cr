...
function FolderIntellijSvg(): React.ReactNode {
  ...
  <defs data-mit-no-recolor>
    <linearGradient id="a" x1="-338.646" x2="-234.114" y1="3272.835" y2="3209.742" gradientTransform="translate(55.497 -331.024)scale(.11021)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#fdd835"></stop>
      <stop offset="1" stop-color="#f57c00"></stop>
    </linearGradient>
    <linearGradient id="b" x1="-316.541" x2="-221.129" y1="3121.343" y2="3204.873" gradientTransform="translate(55.497 -331.024)scale(.11021)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#ef5350"></stop>
      <stop offset=".57" stop-color="#ff6e40"></stop>
      <stop offset="1" stop-color="#f57c00"></stop>
    </linearGradient>
    <linearGradient id="c" x1="-310.483" x2="-367.028" y1="3197.064" y2="3161.75" gradientTransform="translate(55.497 -331.024)scale(.11021)" gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="d" x1="-311.503" x2="-366.707" y1="3117.085" y2="3162.678" gradientTransform="translate(55.497 -331.024)scale(.11021)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#ef5350"></stop>
...
function FolderIntellijIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderIntellijSvg} {...props} />
};

export default FolderIntellijIcon;
