...
function FolderCobolOpenSvg(): React.ReactNode {
...
function FolderCobolOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderCobolOpenSvg} {...props} />
};
