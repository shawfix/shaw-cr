...
function FolderNgrxStoreSvg(): React.ReactNode {
...
function FolderNgrxStoreIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderNgrxStoreSvg} {...props} />
};

export default FolderNgrxStoreIcon;
