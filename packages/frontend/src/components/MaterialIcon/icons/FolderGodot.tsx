...
function FolderGodotSvg(): React.ReactNode {
...
function FolderGodotIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderGodotSvg} {...props} />
};

export default FolderGodotIcon;
