...
function FolderRoutesSvg(): React.ReactNode {
...
function FolderRoutesIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderRoutesSvg} {...props} />
};

export default FolderRoutesIcon;
