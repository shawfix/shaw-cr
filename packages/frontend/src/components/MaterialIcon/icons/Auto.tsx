...
function AutoSvg(): React.ReactNode {
  ...
  <path fill="var(--material-icon-color, #cfd8dc)" d="M3.197 12c.718 0 1.32.583 1.444 1.286.613 3.483 3.675 6.13 7.359 6.13s6.746-2.647 7.359-6.13c.124-.703.726-1.286 1.444-1.286.719 0 1.279.581 1.187 1.289C21.353 18.203 17.123 22 12 22s-9.353-3.797-9.99-8.711C1.918 12.58 2.478 12 3.197 12"></path>
  ...
  <path fill="var(--material-icon-color, #cfd8dc)" d="M7.133 9.32c-.442-.488.053-1.262.657-1.027l4.912 1.91c1.114.434 1.538 1.84.862 2.855a1.785 1.785 0 0 1-2.83.222l-3.6-3.96Z"></path>
</svg>
;
};

function AutoIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={AutoSvg} {...props} />
};
