...
function FolderContainerSvg(): React.ReactNode {
...
function FolderContainerIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderContainerSvg} {...props} />
};
