...
function FolderSvelteSvg(): React.ReactNode {
...
function FolderSvelteIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderSvelteSvg} {...props} />
};

export default FolderSvelteIcon;
