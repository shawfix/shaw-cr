...
function FolderCloudFunctionsSvg(): React.ReactNode {
...
function FolderCloudFunctionsIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderCloudFunctionsSvg} {...props} />
};

export default FolderCloudFunctionsIcon;
