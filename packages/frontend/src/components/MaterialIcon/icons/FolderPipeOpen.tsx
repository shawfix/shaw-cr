...
function FolderPipeOpenSvg(): React.ReactNode {
...
function FolderPipeOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderPipeOpenSvg} {...props} />
};
