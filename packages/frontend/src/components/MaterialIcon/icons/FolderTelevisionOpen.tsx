...
function FolderTelevisionOpenSvg(): React.ReactNode {
...
function FolderTelevisionOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderTelevisionOpenSvg} {...props} />
};
