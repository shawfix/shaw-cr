...
function FolderConfigOpenSvg(): React.ReactNode {
...
function FolderConfigOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderConfigOpenSvg} {...props} />
};
