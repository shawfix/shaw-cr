...
function FolderReduxReducerOpenSvg(): React.ReactNode {
...
function FolderReduxReducerOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderReduxReducerOpenSvg} {...props} />
};

export default FolderReduxReducerOpenIcon;
