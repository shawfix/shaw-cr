...
function FolderWordpressOpenSvg(): React.ReactNode {
...
function FolderWordpressOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderWordpressOpenSvg} {...props} />
};
