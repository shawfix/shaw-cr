...
function FolderGitlabOpenSvg(): React.ReactNode {
  ...
  <g data-mit-no-recolor>
    ...
    <path fill="#f9a825" d="m19.772 25.407 1.764 1.333 1.072.81a.724.724 0 0 0 .873 0l1.072-.81 1.766-1.333-3.27-2.471Z"></path>
...
function FolderGitlabOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderGitlabOpenSvg} {...props} />
};
