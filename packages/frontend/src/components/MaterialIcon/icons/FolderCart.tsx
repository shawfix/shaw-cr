...
function FolderCartSvg(): React.ReactNode {
...
function FolderCartIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderCartSvg} {...props} />
};

export default FolderCartIcon;
