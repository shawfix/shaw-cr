...
function NetlifySvg(): React.ReactNode {
  ...
  <path fill="var(--material-icon-color, #cfd8dc)" d="M14.855 15.172h-1.523l-.127-.127V11.48c0-.634-.249-1.125-1.013-1.142-.394-.01-.844 0-1.325.019l-.072.074v4.61l-.127.128H9.146l-.128-.127V8.956l.128-.127h3.425a2.41 2.41 0 0 1 2.41 2.41v3.806z"></path>
</svg>
;
};

function NetlifyIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={NetlifySvg} {...props} />
};
