...
function FolderAndroidOpenSvg(): React.ReactNode {
...
function FolderAndroidOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderAndroidOpenSvg} {...props} />
};
