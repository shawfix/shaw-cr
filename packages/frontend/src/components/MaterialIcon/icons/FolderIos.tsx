...
function FolderIosSvg(): React.ReactNode {
...
function FolderIosIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderIosSvg} {...props} />
};

export default FolderIosIcon;
