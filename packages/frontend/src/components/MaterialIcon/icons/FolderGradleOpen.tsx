...
function FolderGradleOpenSvg(): React.ReactNode {
...
function FolderGradleOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderGradleOpenSvg} {...props} />
};
