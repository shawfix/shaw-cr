...
function FolderClientSvg(): React.ReactNode {
...
function FolderClientIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderClientSvg} {...props} />
};

export default FolderClientIcon;
