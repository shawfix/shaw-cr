...
function FolderLogOpenSvg(): React.ReactNode {
...
function FolderLogOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderLogOpenSvg} {...props} />
};
