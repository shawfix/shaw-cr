...
function FolderDecoratorsOpenSvg(): React.ReactNode {
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="1em" height="1em">
  <path fill="var(--material-icon-color, #ab47bc)" d="M24.667 27.333h-20A2.667 2.667 0 0 1 2 24.667v-16A2.657 2.657 0 0 1 4.648 6h8.019l2.666 2.667h9.334a2.68 2.68 0 0 1 2.666 2.666H4.667v13.334L7.52 14h22.76l-3.04 11.333a2.67 2.67 0 0 1-2.573 2"></path>
...
function FolderDecoratorsOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderDecoratorsOpenSvg} {...props} />
};

export default FolderDecoratorsOpenIcon;
