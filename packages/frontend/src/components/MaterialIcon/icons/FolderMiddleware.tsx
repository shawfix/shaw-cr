...
function FolderMiddlewareSvg(): React.ReactNode {
...
function FolderMiddlewareIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderMiddlewareSvg} {...props} />
};

export default FolderMiddlewareIcon;
