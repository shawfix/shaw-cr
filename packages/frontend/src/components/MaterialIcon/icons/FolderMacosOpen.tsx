...
function FolderMacosOpenSvg(): React.ReactNode {
...
function FolderMacosOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderMacosOpenSvg} {...props} />
};
