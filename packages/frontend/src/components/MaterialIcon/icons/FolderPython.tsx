...
function FolderPythonSvg(): React.ReactNode {
...
function FolderPythonIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderPythonSvg} {...props} />
};
