...
function FolderVideoSvg(): React.ReactNode {
...
function FolderVideoIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderVideoSvg} {...props} />
};
