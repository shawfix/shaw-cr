...
function FolderStylusOpenSvg(): React.ReactNode {
...
function FolderStylusOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderStylusOpenSvg} {...props} />
};
