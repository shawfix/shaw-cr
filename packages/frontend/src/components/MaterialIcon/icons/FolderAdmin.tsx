...
function FolderAdminSvg(): React.ReactNode {
...
function FolderAdminIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderAdminSvg} {...props} />
};
