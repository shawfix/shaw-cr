...
function FolderAngularSvg(): React.ReactNode {
...
function FolderAngularIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderAngularSvg} {...props} />
};
