...
function FolderMobileOpenSvg(): React.ReactNode {
...
function FolderMobileOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderMobileOpenSvg} {...props} />
};
