...
function FolderDeltaSvg(): React.ReactNode {
...
function FolderDeltaIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderDeltaSvg} {...props} />
};

export default FolderDeltaIcon;
