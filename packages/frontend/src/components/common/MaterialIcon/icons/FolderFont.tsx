...
function FolderFontSvg(): React.ReactNode {
...
function FolderFontIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderFontSvg} {...props} />
};
