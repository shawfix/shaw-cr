...
function FolderSassSvg(): React.ReactNode {
...
function FolderSassIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderSassSvg} {...props} />
};

export default FolderSassIcon;
