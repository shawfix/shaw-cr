...
function FolderCoreSvg(): React.ReactNode {
...
function FolderCoreIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderCoreSvg} {...props} />
};

export default FolderCoreIcon;
