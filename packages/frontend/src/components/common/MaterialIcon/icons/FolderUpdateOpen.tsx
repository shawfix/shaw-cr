...
function FolderUpdateOpenSvg(): React.ReactNode {
...
function FolderUpdateOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderUpdateOpenSvg} {...props} />
};
