...
function FolderDocsOpenSvg(): React.ReactNode {
...
function FolderDocsOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderDocsOpenSvg} {...props} />
};
