...
function FolderGithubOpenSvg(): React.ReactNode {
...
function FolderGithubOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderGithubOpenSvg} {...props} />
};
