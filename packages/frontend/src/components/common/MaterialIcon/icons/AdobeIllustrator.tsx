...
function AdobeIllustratorSvg(): React.ReactNode {
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="1em" height="1em">
  <rect width="28" height="28" x="2" y="2" fill="#5d4037" rx="4"></rect>
...
function AdobeIllustratorIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={AdobeIllustratorSvg} {...props} />
};
