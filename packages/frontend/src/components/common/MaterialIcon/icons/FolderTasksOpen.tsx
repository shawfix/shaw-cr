...
function FolderTasksOpenSvg(): React.ReactNode {
...
function FolderTasksOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderTasksOpenSvg} {...props} />
};

export default FolderTasksOpenIcon;
