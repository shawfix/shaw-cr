...
function FolderMoonSvg(): React.ReactNode {
...
function FolderMoonIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderMoonSvg} {...props} />
};

export default FolderMoonIcon;
