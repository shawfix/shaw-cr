...
function FolderContextSvg(): React.ReactNode {
...
function FolderContextIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderContextSvg} {...props} />
};
