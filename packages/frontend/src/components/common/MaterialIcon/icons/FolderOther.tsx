...
function FolderOtherSvg(): React.ReactNode {
...
function FolderOtherIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderOtherSvg} {...props} />
};

export default FolderOtherIcon;
