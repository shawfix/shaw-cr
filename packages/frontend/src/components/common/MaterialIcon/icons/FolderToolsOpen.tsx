...
function FolderToolsOpenSvg(): React.ReactNode {
...
function FolderToolsOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderToolsOpenSvg} {...props} />
};
