...
function FolderFunctionsSvg(): React.ReactNode {
...
function FolderFunctionsIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderFunctionsSvg} {...props} />
};
