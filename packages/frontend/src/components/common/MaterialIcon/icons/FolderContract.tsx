...
function FolderContractSvg(): React.ReactNode {
...
function FolderContractIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderContractSvg} {...props} />
};
