...
function FolderBicepOpenSvg(): React.ReactNode {
...
function FolderBicepOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderBicepOpenSvg} {...props} />
};
