...
function FolderKustoSvg(): React.ReactNode {
...
function FolderKustoIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderKustoSvg} {...props} />
};
