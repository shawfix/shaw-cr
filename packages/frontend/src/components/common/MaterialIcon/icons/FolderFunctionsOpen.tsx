...
function FolderFunctionsOpenSvg(): React.ReactNode {
  ...
  <path fill="var(--material-icon-color, #b3e5fc)" d="M24 16h-2.982l.14-1.676.002-.01a1.945 1.945 0 0 1 3.848-.485l1.475-1.687a3.9 3.9 0 0 0-3.01-2.126 4.143 4.143 0 0 0-4.263 4.105L19.048 16H16v2h2.87l-.529 5.874a2.05 2.05 0 0 1-1.348 1.776l-.026.009a1.92 1.92 0 0 1-2.451-1.465l-1.477 1.687a3.91 3.91 0 0 0 2.99 2.1 4.13 4.13 0 0 0 4.274-4.08L20.839 18H24Zm8 4.929-1.414-1.414-2.829 2.828-2.828-2.828-1.414 1.414 2.828 2.828-2.828 2.829L24.929 28l2.828-2.828L30.586 28 32 26.586l-2.828-2.829z"></path>
</svg>
;
};

function FolderFunctionsOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderFunctionsOpenSvg} {...props} />
};
