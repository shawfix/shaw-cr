...
function FolderRepositorySvg(): React.ReactNode {
...
function FolderRepositoryIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderRepositorySvg} {...props} />
};
