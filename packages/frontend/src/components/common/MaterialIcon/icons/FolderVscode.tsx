...
function FolderVscodeSvg(): React.ReactNode {
...
function FolderVscodeIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderVscodeSvg} {...props} />
};
