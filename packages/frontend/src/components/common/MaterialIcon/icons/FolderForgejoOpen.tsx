...
function FolderForgejoOpenSvg(): React.ReactNode {
...
function FolderForgejoOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderForgejoOpenSvg} {...props} />
};
