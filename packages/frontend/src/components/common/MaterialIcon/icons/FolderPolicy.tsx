...
function FolderPolicySvg(): React.ReactNode {
...
function FolderPolicyIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderPolicySvg} {...props} />
};
