...
function FolderIntellijLightSvg(): React.ReactNode {
  ...
  <defs data-mit-no-recolor>
    <linearGradient id="a" x1="-338.646" x2="-234.114" y1="3611.926" y2="3548.833" gradientTransform="translate(55.497 -368.395)scale(.11021)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#fdd835"></stop>
      <stop offset="1" stop-color="#f57c00"></stop>
    </linearGradient>
    <linearGradient id="b" x1="-316.541" x2="-221.129" y1="3460.434" y2="3543.963" gradientTransform="translate(55.497 -368.395)scale(.11021)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#ef5350"></stop>
      <stop offset=".57" stop-color="#ff6e40"></stop>
      <stop offset="1" stop-color="#f57c00"></stop>
    </linearGradient>
    <linearGradient id="c" x1="-310.483" x2="-367.028" y1="3536.154" y2="3500.841" gradientTransform="translate(55.497 -368.395)scale(.11021)" gradientUnits="userSpaceOnUse">
    ...
    <linearGradient id="d" x1="-311.503" x2="-366.707" y1="3456.176" y2="3501.769" gradientTransform="translate(55.497 -368.395)scale(.11021)" gradientUnits="userSpaceOnUse">
      <stop offset="0" stop-color="#ef5350"></stop>
      <stop offset=".364" stop-color="#ec407a"></stop>
      <stop offset="1" stop-color="#ec407a"></stop>
    </linearGradient>
  </defs>
  <path fill="var(--material-icon-color, #b0bec5)" d="m13.844 7.536-1.288-1.072A2 2 0 0 0 11.276 6H4a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h24a2 2 0 0 0 2-2V10a2 2 0 0 0-2-2H15.124a2 2 0 0 1-1.28-.464"></path>
...
function FolderIntellijLightIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderIntellijLightSvg} {...props} />
};

export default FolderIntellijLightIcon;
