...
function FolderPrismaSvg(): React.ReactNode {
...
function FolderPrismaIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderPrismaSvg} {...props} />
};
