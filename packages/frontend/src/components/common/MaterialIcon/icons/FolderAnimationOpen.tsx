...
function FolderAnimationOpenSvg(): React.ReactNode {
...
function FolderAnimationOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderAnimationOpenSvg} {...props} />
};
