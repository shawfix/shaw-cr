...
function FolderCloudflareOpenSvg(): React.ReactNode {
...
function FolderCloudflareOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderCloudflareOpenSvg} {...props} />
};
