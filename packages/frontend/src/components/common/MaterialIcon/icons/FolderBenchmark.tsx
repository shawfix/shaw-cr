...
function FolderBenchmarkSvg(): React.ReactNode {
...
function FolderBenchmarkIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderBenchmarkSvg} {...props} />
};
