...
function FolderMarkdownOpenSvg(): React.ReactNode {
...
function FolderMarkdownOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderMarkdownOpenSvg} {...props} />
};
