...
function FolderSyntaxOpenSvg(): React.ReactNode {
...
function FolderSyntaxOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderSyntaxOpenSvg} {...props} />
};
