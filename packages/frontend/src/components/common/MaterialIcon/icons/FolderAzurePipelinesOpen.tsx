...
function FolderAzurePipelinesOpenSvg(): React.ReactNode {
...
function FolderAzurePipelinesOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderAzurePipelinesOpenSvg} {...props} />
};
