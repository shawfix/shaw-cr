...
function FolderDartOpenSvg(): React.ReactNode {
...
function FolderDartOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderDartOpenSvg} {...props} />
};
