...
function FolderPlasticOpenSvg(): React.ReactNode {
...
function FolderPlasticOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderPlasticOpenSvg} {...props} />
};
