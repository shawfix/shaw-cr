...
function FolderMessagesSvg(): React.ReactNode {
...
function FolderMessagesIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderMessagesSvg} {...props} />
};
