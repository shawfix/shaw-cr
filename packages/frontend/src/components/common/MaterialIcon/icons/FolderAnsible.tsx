...
function FolderAnsibleSvg(): React.ReactNode {
...
function FolderAnsibleIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderAnsibleSvg} {...props} />
};
