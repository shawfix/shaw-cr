...
function FolderUtilsOpenSvg(): React.ReactNode {
...
function FolderUtilsOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderUtilsOpenSvg} {...props} />
};
