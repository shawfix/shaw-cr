...
function FolderMercurialOpenSvg(): React.ReactNode {
...
function FolderMercurialOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderMercurialOpenSvg} {...props} />
};
