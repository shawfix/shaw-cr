...
function FolderHuskyOpenSvg(): React.ReactNode {
...
function FolderHuskyOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderHuskyOpenSvg} {...props} />
};
