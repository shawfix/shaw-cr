...
function FolderTargetSvg(): React.ReactNode {
...
function FolderTargetIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderTargetSvg} {...props} />
};
