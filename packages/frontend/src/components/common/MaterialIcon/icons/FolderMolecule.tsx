...
function FolderMoleculeSvg(): React.ReactNode {
  return <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="1em" height="1em">
  <path d="M13.84376,7.6l-1.28749-1.0729a2,2,0,0,0-1.28036-.46355H4a2,2,0,0,0-2,2v16a2,2,0,0,0,2,2H28a2,2,0,0,0,2-2v-14a2,2,0,0,0-2-2H15.12412A2,2,0,0,1,13.84376,7.6Z" style="fill:#ff9800"></path>
...
function FolderMoleculeIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderMoleculeSvg} {...props} />
};
