...
function FolderFlowSvg(): React.ReactNode {
...
function FolderFlowIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderFlowSvg} {...props} />
};
