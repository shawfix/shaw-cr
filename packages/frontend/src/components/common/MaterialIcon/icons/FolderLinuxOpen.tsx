...
function FolderLinuxOpenSvg(): React.ReactNode {
...
function FolderLinuxOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderLinuxOpenSvg} {...props} />
};
