...
function FolderMappingsSvg(): React.ReactNode {
...
function FolderMappingsIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderMappingsSvg} {...props} />
};
