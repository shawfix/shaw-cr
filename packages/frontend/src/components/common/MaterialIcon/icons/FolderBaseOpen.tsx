...
function FolderBaseOpenSvg(): React.ReactNode {
...
function FolderBaseOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderBaseOpenSvg} {...props} />
};
