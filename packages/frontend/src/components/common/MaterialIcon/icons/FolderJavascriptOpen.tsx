...
function FolderJavascriptOpenSvg(): React.ReactNode {
...
function FolderJavascriptOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderJavascriptOpenSvg} {...props} />
};
