...
function TurborepoSvg(): React.ReactNode {
  ...
  <path fill="var(--material-icon-color, #cfd8dc)" d="M16 8a8 8 0 1 0 8 8 8 8 0 0 0-8-8m0 12a4 4 0 1 1 4-4 4 4 0 0 1-4 4"></path>
...
function TurborepoIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={TurborepoSvg} {...props} />
};
