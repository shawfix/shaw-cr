...
function FolderBuildkiteSvg(): React.ReactNode {
...
function FolderBuildkiteIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderBuildkiteSvg} {...props} />
};

export default FolderBuildkiteIcon;
