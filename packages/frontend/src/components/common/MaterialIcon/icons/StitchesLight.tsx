...
function StitchesLightIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={StitchesLightSvg} {...props} />
};

export default StitchesLightIcon;
