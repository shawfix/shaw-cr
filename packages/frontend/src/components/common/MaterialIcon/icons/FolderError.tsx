...
function FolderErrorSvg(): React.ReactNode {
...
function FolderErrorIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderErrorSvg} {...props} />
};
