...
function FolderSecureSvg(): React.ReactNode {
...
function FolderSecureIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderSecureSvg} {...props} />
};
