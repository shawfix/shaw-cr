...
function FolderSupabaseSvg(): React.ReactNode {
...
function FolderSupabaseIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderSupabaseSvg} {...props} />
};

export default FolderSupabaseIcon;
