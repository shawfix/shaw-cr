...
function FolderNetlifySvg(): React.ReactNode {
...
function FolderNetlifyIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderNetlifySvg} {...props} />
};
