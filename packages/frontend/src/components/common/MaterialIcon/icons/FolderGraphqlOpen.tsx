...
function FolderGraphqlOpenSvg(): React.ReactNode {
...
function FolderGraphqlOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderGraphqlOpenSvg} {...props} />
};
