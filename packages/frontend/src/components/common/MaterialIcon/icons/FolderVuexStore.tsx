...
function FolderVuexStoreSvg(): React.ReactNode {
...
function FolderVuexStoreIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderVuexStoreSvg} {...props} />
};
