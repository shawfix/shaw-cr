...
function FolderDrizzleSvg(): React.ReactNode {
...
function FolderDrizzleIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderDrizzleSvg} {...props} />
};
