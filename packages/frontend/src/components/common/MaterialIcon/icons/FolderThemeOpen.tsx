...
function FolderThemeOpenSvg(): React.ReactNode {
...
function FolderThemeOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderThemeOpenSvg} {...props} />
};
