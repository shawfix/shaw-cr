...
function FolderMockOpenSvg(): React.ReactNode {
...
function FolderMockOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderMockOpenSvg} {...props} />
};
