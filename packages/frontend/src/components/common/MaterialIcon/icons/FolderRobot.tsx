...
function FolderRobotSvg(): React.ReactNode {
...
function FolderRobotIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderRobotSvg} {...props} />
};
