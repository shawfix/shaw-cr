...
function FolderPluginOpenSvg(): React.ReactNode {
...
function FolderPluginOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderPluginOpenSvg} {...props} />
};
