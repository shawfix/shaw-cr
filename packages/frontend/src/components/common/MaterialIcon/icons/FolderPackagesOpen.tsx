...
function FolderPackagesOpenSvg(): React.ReactNode {
...
function FolderPackagesOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderPackagesOpenSvg} {...props} />
};
