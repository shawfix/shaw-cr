...
function FolderApolloOpenSvg(): React.ReactNode {
...
function FolderApolloOpenIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderApolloOpenSvg} {...props} />
};
