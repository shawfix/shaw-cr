...
function FolderIoneEightNSvg(): React.ReactNode {
...
function FolderIoneEightNIcon(props: Partial<MaterialIconProps>): React.ReactNode {
  return <Icon component={FolderIoneEightNSvg} {...props} />
};

export default FolderIoneEightNIcon;
