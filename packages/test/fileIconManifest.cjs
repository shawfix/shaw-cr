...
const FileNamePattern = require('./FileNamePattern.cjs');
const parseByPattern = require('./patterns.cjs');
...
fs.writeFileSync('./iconManifest.json', JSON.stringify(fileIcons, null, 2), {
  encoding: 'utf-8',
  flag: 'w',
});
